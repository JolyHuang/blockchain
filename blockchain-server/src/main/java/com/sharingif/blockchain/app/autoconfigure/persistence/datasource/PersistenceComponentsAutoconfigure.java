...
public class PersistenceComponentsAutoconfigure {
	...
	public org.apache.tomcat.jdbc.pool.DataSource createDataSource(DataSourcePoolConfig dataSourcePoolConfig, TextEncryptor propertyTextEncryptor) throws SQLException {
